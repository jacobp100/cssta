...
var getStyles = function getStyles() {
  ...
  var exportedVariables = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

  var appliedVariables = Object.assign({}, variablesFromScope, typeof exportedVariables === 'function' ? exportedVariables(variablesFromScope) : exportedVariables);
...
var VariablesProvider = function (_Component) {
  ...
  _createClass(VariablesProvider, [{
    ...
    value: function componentWillUpdate(nextProps, nextState, nextContext) {
      ...
      var variablesFromScopeChanged = !shallowEqual(this.state.variablesFromScope, nextState.variablesFromScope);
      var nextExportedVariablesChanged = typeof nextProps.exportedVariables === 'function' ? true : !shallowEqual(this.props.exportedVariables, nextProps.exportedVariables);
