...
it("adds adds a boolean property", () =>
  runTest({
...
it("does not add boolean properties if they are not passed", () =>
  runTest({
    classNameMap: { booleanAttribute: { true: "class" } },
    inputProps: {}
  }));

it("adds adds a string property", () =>
  runTest({
...
it("does not add string properties if they are not passed", () =>
  runTest({
    classNameMap: { stringAttribute: { value: "class" } },
    inputProps: {}
  }));

it("passes extraneous props down", () =>
  runTest({
    classNameMap: { booleanAttribute: { true: "class" } },
...
it("allows setting className", () =>
  runTest({
    inputProps: { className: "test" },
    expectedProps: { className: "test" }
  }));

it("allows extending className with default class name", () =>
  runTest({
    defaultClassName: "default",
    inputProps: { className: "test" },
...
it("allows extending className with props", () =>
  runTest({
    classNameMap: { booleanAttribute: { true: "class" } },
